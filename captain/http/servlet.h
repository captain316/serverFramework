 ...
 * @brief Servlet封装
 */
#ifndef __CAPTAIN_HTTP_SERVLET_H__
#define __CAPTAIN_HTTP_SERVLET_H__
...
#include "captain/include/thread.h"
...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(captain::http::HttpRequest::ptr request
                   , captain::http::HttpResponse::ptr response
                   , captain::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (captain::http::HttpRequest::ptr request
                   , captain::http::HttpResponse::ptr response
                   , captain::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(captain::http::HttpRequest::ptr request
                   , captain::http::HttpResponse::ptr response
                   , captain::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
...
public:
    ...
    /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /CAPTAIN_*
