...
int32_t FunctionServlet::handle(captain::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("captain/1.0.0"));
}

int32_t ServletDispatch::handle(captain::http::HttpRequest::ptr request
               , captain::http::HttpResponse::ptr response
               , captain::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(captain::http::HttpRequest::ptr request
                   , captain::http::HttpResponse::ptr response
                   , captain::http::HttpSession::ptr session) {
    response->setStatus(captain::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "captain/1.0.0");
